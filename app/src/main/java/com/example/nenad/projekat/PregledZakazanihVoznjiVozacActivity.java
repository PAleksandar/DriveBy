...
public class PregledZakazanihVoznjiVozacActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<ZakazanaVoznja,AllUsersViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<ZakazanaVoznja, AllUsersViewHolder>
            ...
            protected void populateViewHolder(AllUsersViewHolder viewHolder, ZakazanaVoznja model, final int position) {
                ...
                viewHolder.setUser_name(model.getPocetak() + " - "+ model.getKraj()+model.getDay()+ ". " + model.getMonth()+ ". "+ model.getYear()+".");
                viewHolder.setUser_status("Vozac: "+ model.getDriver().getName());

                viewHolder.setUser_image(getApplicationContext(),model.getDriver().getUser_image());
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                       ...
                       // Toast.makeText(PregledZakazanihVoznjiVozacActivity.this,visit_user_id,Toast.LENGTH_LONG).show();
                        final AlertDialog alertDialog = new AlertDialog.Builder(PregledZakazanihVoznjiVozacActivity.this).create();
                                ...
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int which) {
                                        FirebaseDatabase.getInstance().getReference()
                                                .child("ZakazaneVoznje").child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                                                .child(visit_user_id).removeValue();
                                    }
                                });
